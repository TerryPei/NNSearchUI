...
class DartsSubgraphDatasetInMem(Dataset):
    ...
    @staticmethod
    def build_batch(edges, operations2idx, path):
...
# class BaselinesDataset(object):
    
#     def __init__(self, root):
#         super(BaselinesDataset, self).__init__()
#         self.data = BaselinesDataset._load_from_file(root)
